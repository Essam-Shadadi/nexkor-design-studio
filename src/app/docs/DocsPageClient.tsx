...
const NAV = [
  { key: "docs.nav.gettingStarted", href: "/docs/getting-started" },
  { key: "docs.nav.foundations", href: "/docs/foundations" },
  { key: "docs.nav.components", href: "/docs/components" },
  { key: "docs.nav.tokens", href: "/docs/tokens" },
];
      ...
      <main className="flex-1 py-12">
        <Container className="prose prose-gray dark:prose-invert max-w-3xl">
          <h1 className="font-heading text-3xl mb-6">
            {t("docs.layout.main.title")}
          </h1>

          <p className="text-gray-600 dark:text-gray-300">
            {t("docs.layout.main.subtitle")}
          </p>
